...
const sampleProducts = [
    {
        ...
        images: ['http://googleusercontent.com/file_content/8'],
        featured: true,
        reviews: [
    ...
    },
    {
        ...
        images: ['http://googleusercontent.com/file_content/6'],
        featured: true,
        reviews: [
    ...
    },
    {
        ...
        images: ['http://googleusercontent.com/file_content/5'],
        featured: true,
        reviews: [
    ...
    },
    {
        ...
        images: ['http://googleusercontent.com/file_content/7'],
        featured: true,
        reviews: [
            { user: 'Riya', rating: 5, comment: 'Looks even better in person. Very sturdy and was easy to assemble.' },
        ],
    },
    { id: 5, name: 'Samsung Galaxy S24 Ultra', category: 'Electronics', price: 129999, rating: 4.8, availability: 'In Stock', description: 'Unleash new levels of creativity and productivity with the Galaxy S24 Ultra. Featuring the revolutionary Galaxy AI, a stunning Dynamic AMOLED 2X display, and an integrated S Pen, this phone is designed to redefine your mobile experience.', images: ['http://googleusercontent.com/file_content/9'], featured: false, reviews: [{user: 'Aisha', rating: 5, comment: 'The AI features are incredible! Circle to Search is a game changer.'}]},
    { id: 6, name: 'Floral Maxi Dress', category: 'Fashion', price: 2799, rating: 4.6, availability: 'In Stock', description: 'A beautiful and breezy dress perfect for summer brunches or beach vacations.', images: ['http://googleusercontent.com/file_content/10'], featured: false, reviews: [{user: 'Kiara', rating: 5, comment: 'So comfortable and pretty! I get compliments every time I wear it.'}]},
    { id: 7, name: 'Ergonomic Office Chair', category: 'Home', price: 14999, rating: 4.9, availability: 'Out of Stock', description: 'Upgrade your home office with this premium ergonomic chair. Designed for maximum comfort and support, it features adjustable lumbar support, armrests, and a breathable mesh back to keep you comfortable during long workdays.', images: ['https://images.unsplash.com/photo-1580480055273-228ff5388ef8?q=80&w=1974&auto=format&fit=crop'], featured: false, reviews: [{user: 'Leo', rating: 5, comment: 'My back pain is gone. This chair is a lifesaver.'}]},
    { id: 8, name: 'Nike Air Max Pulse', category: 'Fashion', price: 11895, rating: 4.7, availability: 'In Stock', description: 'Inspired by the London music scene, the Air Max Pulse brings an underground touch to the iconic Air Max line. Its point-loaded cushioning, revamped from the incredibly plush Air Max 270, delivers better bounce and responsiveness.', images: ['http://googleusercontent.com/file_content/4'], featured: true, reviews: [{user: 'Vivaan', rating: 5, comment: 'Super comfortable and they look amazing.'}]},
];
...
function Header({ setView, searchQuery, setSearchQuery }) {
        ...
        <header className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-md shadow-sm sticky top-0 z-50 transition-colors">
            <nav className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-20">
                    <a href="#" onClick={(e) => { e.preventDefault(); setView({ page: 'home' }); }} className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 to-purple-500">ShopZen</a>
...
function ProductCard({ product, setView }) {
                ...
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 bg-black/50 z-[100] flex items-center justify-center p-4">
                    <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.9, opacity: 0 }} className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md relative">
                        ...
                        <div className="p-8">
                            ...
                            <p className="text-center text-gray-500 dark:text-gray-400 mb-6">{isLoginView ? 'Sign in to continue' : 'Get started with ShopZen'}</p>
        ...
        <footer className="bg-gray-800 text-white mt-12">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div><h3 className="text-xl font-bold mb-4">ShopZen</h3><p className="text-gray-400">Your one-stop shop for everything you need. Quality products, unbeatable prices.</p></div>
                ...
                <div className="text-center text-gray-500 mt-8 border-t border-gray-700 pt-6">© 2025 ShopZen. All Rights Reserved.</div>
            </div>
        </footer>
    );
}

function OrderSuccessModal({ setView }) {
    return (
...
function HomePage({ setView, searchQuery, setSearchQuery }) {
...
function ProductDetailPage({ productId, setView }) {
...
// ... (Other pages like CartPage, WishlistPage, CheckoutPage remain the same)
// ... (I will only show the new AccountPage for brevity)
...
function ResellPage({ setView, item }) {
